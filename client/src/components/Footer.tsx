        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              <h3 className="text-2xl font-bold text-purple-primary">EventHub</h3>
              <span className="text-purple-secondary ml-2 text-sm font-medium">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-muted-foreground hover:text-purple-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              {footerLinks.organizers.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="hover:text-purple-primary transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
